...
@Component({
  selector: 'ngx-visit-plan-generate',
  templateUrl: './visit-plan-generate.component.html',
  styleUrls: ['./visit-plan-generate.component.scss'],
})
export class VisitPlanGenerateComponent implements OnInit, OnDestroy {
  date: Date;
  ...
  generateData(bodyForm, nextAction) {
    ...
    this.visitPlanService.generate(dataBody)
