...
@Component({
  selector: 'ngx-filter-visit-plan',
  templateUrl: './filter-visit-plan.component.html',
  styleUrls: ['./filter-visit-plan.component.scss'],
})
export class FilterVisitPlanComponent implements OnInit {
  ...
  openUserDropdown() {
    ...
    this.salesReportVisitPlanService.dropdownUserCollector().pipe(untilDestroyed(this)).subscribe(resp => {
