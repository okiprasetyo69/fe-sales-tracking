...
export class PermissionIndexComponent implements OnInit, OnDestroy {
  ...
  constructor(
    private permAlertService: SalesReportPermissionService,
  ...
  getDatatable() {
    this.dtOptions = {
      ...
      ajax: (dataTablesParameters: any, callback) => {
        ...
        this.permAlertService.indexDatatablesCollector(dataTablesParameters, this.dataFormFilter)
  ...
  print() {
    ...
    popupWin.document.write(`
      <html>
        ...
        <body>
          <h1 class="page-header">Report Sales Permission</h1>
  ...
  export() {
    ...
    this.excelService.exportAsExcelFile(data, 'sales-permission');
  }
  ...
  exportExcelCollector() {
    this.toasterService.popAsync('info', 'Start Download', 'Generating, Pleasewait...');
    this.permAlertService.exportExcelCollector(this.dtParams, this.dataFormFilter).subscribe(data => {
        fileSaver.saveAs(data, 'collector-permission-report.xlsx');
