...
export class PerformanceIndexComponent implements OnInit, OnDestroy {
  ...
  constructor(
    ...
    private logisticReportPerformanceService: LogisticReportPerformanceService,
  ...
  getDatatable() {
    this.dtOptions = {
      ...
      ajax: (dataTablesParameters: any, callback) => {
        ...
        this.logisticReportPerformanceService.indexDatatables(dataTablesParameters, this.dataFormFilter)
          ...
          .subscribe(resp => {
            ...
            if (userArrayList.length != 0) {
              ...
              this.logisticReportPerformanceService.performance(stringUserIdList, this.dataFormFilter).subscribe(res => {
  ...
  print() {
    ...
    popupWin.document.write(`
      <html>
        ...
        <body>
          <h1 class="page-header">Report Performance Logistic</h1>
  ...
  export() {
    ...
    this.excelService.exportAsExcelFile(data, 'logistic-performance');
  }
