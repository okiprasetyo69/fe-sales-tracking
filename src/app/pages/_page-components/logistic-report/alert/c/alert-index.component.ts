...
export class AlertIndexComponent implements OnInit, OnDestroy {
  ...
  constructor(
    ...
    private logisticReportAlertService: LogisticReportAlertService,
  ...
  getDatatable() {
    this.dtOptions = {
      ...
      ajax: (dataTablesParameters: any, callback) => {
        ...
        this.logisticReportAlertService.indexDatatables(dataTablesParameters, this.dataFormFilter)
          ...
          .subscribe(resp => {
            ...
            callback({
              ...
              data: !!resp.data.total ? [{no: '', date: '', user_name: '', branch_name: '', description: ''}] : [],
            });
          });
      },
      columns: [
  ...
  export() {
    ...
    this.excelService.exportAsExcelFile(data, 'logistic-alert');
  }
  ...
  exportExcel() {
    ...
    this.logisticReportAlertService.exportExcel(this.dtParams, this.dataFormFilter).subscribe(data => {
  ...
  exportPdf() {
    this.toasterService.popAsync('info', 'Start Download', 'Generating, Pleasewait...');
    this.logisticReportAlertService.exportPdf(this.dtParams, this.dataFormFilter).subscribe(data => {
