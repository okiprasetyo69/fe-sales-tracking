...
@Component({
  selector: 'ngx-filter-delivery-plan',
  templateUrl: './filter-delivery-plan.component.html',
  styleUrls: ['./filter-delivery-plan.component.scss'],
})
export class FilterDeliveryPlanComponent implements OnInit {
  ...
  openUserDropdown() {
    ...
    this.userService.dropdownUserLogistic().pipe(untilDestroyed(this)).subscribe(resp => {
