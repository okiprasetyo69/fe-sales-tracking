...
export class PerformanceIndexComponent implements OnInit, OnDestroy {
  ...
  constructor(
    ...
    private salesReportPerformanceService: SalesReportPerformanceService,
  ...
  getDatatable() {
    this.dtOptions = {
      ...
      ajax: (dataTablesParameters: any, callback) => {
        ...
        this.salesReportPerformanceService.indexDatatables(dataTablesParameters, this.dataFormFilter)
          ...
          .subscribe(resp => {
            ...
            if (userArrayList.length != 0) {
              ...
              this.salesReportPerformanceService.performance(stringUserIdList, this.dataFormFilter).subscribe(res => {
  ...
  export() {
    ...
    this.excelService.exportAsExcelFile(data, 'sales-performance');
  }
